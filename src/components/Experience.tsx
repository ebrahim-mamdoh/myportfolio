...
const experiences = [
  {
    ...
    period: "2022 - Present",
    description: "Leading frontend development for enterprise-level React applications. Mentoring junior developers and implementing best practices.",
  ...
  },
  {
    ...
    period: "2023",
    description: "Won first place for building an innovative real-time collaboration tool using React and WebSocket technology.",
